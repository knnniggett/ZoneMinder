...
$SLANG = array(
    ...
    'PrivacyCookiesText'    => 'Whether you use a web browser or a mobile app to communicate with the ZoneMinder server, a ZMSESSID cookie is created on the client to uniquely identify a session with the ZoneMinder server. zmCSS and zmSkin cookies are created to remember your style and skin choices. As well other cookies like zmMontageScale are used to store your selections on the montage view and other views.',
